...
//
//    @Test
//    public void shouldHandleExceptionWhenKillingRunningProcessFails() throws IOException, InterruptedException {
//        ProcessExecutor processExecutorMock = mock(UnixProcessExecutor.class);
//        ProcessExecutorFetcher processExecutorFetcher = mock(ProcessExecutorFetcher.class);
//        when(processExecutorFetcher.getProcessExecutorBasedOnOs()).thenReturn(processExecutorMock);
//        ProcessAdapter processAdapter = new ProcessAdapter(processExecutorFetcher);
//
//        doThrow(new IOException()).when(processAdapter).killRunningProcess("12345");
//
...
//
//    @Test
//    public void shouldHandleExceptionWhenFindingProcessIdFails() throws ReflectiveOperationException {
//        ProcessExecutor processExecutorMock = mock(UnixProcessExecutor.class);
//        ProcessExecutorFetcher processExecutorFetcher = mock(ProcessExecutorFetcher.class);
//        when(processExecutorFetcher.getProcessExecutorBasedOnOs()).thenReturn(processExecutorMock);
//        ProcessAdapter processAdapter = new ProcessAdapter(processExecutorFetcher);
...
//
//    @Test
//    public void shouldHandleExceptionWhenProcessIsRunningFails() throws IOException, InterruptedException {
//        ProcessExecutor processExecutorMock = mock(UnixProcessExecutor.class);
//        ProcessExecutorFetcher processExecutorFetcher = mock(ProcessExecutorFetcher.class);
//        when(processExecutorFetcher.getProcessExecutorBasedOnOs()).thenReturn(processExecutorMock);
//        ProcessAdapter processAdapter = new ProcessAdapter(processExecutorFetcher);
